...
void TD3DDescriptorCache::AppendDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE Type, const std::vector<TD3DDescriptor>& SrcDescriptors, TD3DDescriptor& OutDescriptor)
{
	...
	Device->GetD3DDevice()->CopyDescriptors(1, &OutDescriptor.CpuHandle, &SlotsNeeded, SlotsNeeded, SrcCpuDescriptors.data(), nullptr, D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
